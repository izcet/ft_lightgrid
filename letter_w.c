...
/*   Updated: 2017/06/28 22:17:03 by irhett           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	letter_w(t_letter **l)
{
	...
	ft_memcpy(l[etter]->dots[4], "0000000", 7);
	l[etter]->dots[5] = ft_strnew(7 + 1);
	ft_memcpy(l[etter]->dots[5], "1000001", 7);
	l[etter]->dots[6] = ft_strnew(7 + 1);
	ft_memcpy(l[etter]->dots[6], "1001001", 7);
	l[etter]->dots[7] = ft_strnew(7 + 1);
	ft_memcpy(l[etter]->dots[7], "1010101", 7);
}
